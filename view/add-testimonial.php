...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sharp Cut Lawn Service, Branchburg NJ. Current customer reviews on
                                      Sharp Cut Lawn Service's performance">
    <meta name="author" content="Sharp Cut Lawn Service">
    <meta name="ROBOTS" content="INDEX, FOLLOW">
    <link rel="icon" type="image/x-icon" href="../img/grass-favicon.png" />
    <title>Sharp Cut Lawn Service | Add Testimonial</title>
  ...
  <body>
    <?php 
      ...
      require_once('../templates/add-testimonial.html');
