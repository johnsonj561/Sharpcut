...
<html lang="en">
  <head>
    ...
    <title>Sharp Cut Lawn Service | Edit Work Order</title>
    <link href="register.php" rel="canonical">
    ...
    <div class="container">
      <div class="row">
        <div class="box">
          ...
          <div class="col-lg-12">
            <h2 class = "intro-text text-center">Make Changes To <?php echo $userInfo['name'];?>'s Account</h2>
            <hr>
          </div>
          
          <div class="col-lg-12">
            <form role="form" action="../php/update-work-order.php" method = "post">
              <div class="row">
                <table class='statement-table'>
                  <thead><th>Job ID</th><th>Date</th><th>Job Description</th><th>Price</th>
