...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sharp Cut Lawn Service, Branchburg NJ. Review Sharp Cut's available
                                      services to see if Sharp Cut is the right business to care for your
                                      property">
    <meta name="author" content="Sharp Cut Lawn Service">
    <meta name="ROBOTS" content="INDEX, FOLLOW">
    <link rel="icon" type="image/x-icon" href="../img/grass-favicon.png" />
    <title>Sharp Cut Lawn Service | Services</title>
